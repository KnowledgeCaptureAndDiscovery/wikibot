...
public class CategoryDefinition {
    ...
    private static int countArticlesOfCategory(String categoryTitle) throws UnsupportedEncodingException, JSONException{
        ...
        for(int i = 0; i < categories.length(); i++)
        {
        	JSONObject cat = (JSONObject) categories.get(i);
        	String t = cat.getString("title").replace(" ", "_");
        	//System.out.println("Now printing: " + t);
        	total+= countArticlesOfCategory(t);
        	//System.out.println("Now printing: " + total);
        }
        return total;
    }
    ...
    public static void main(String[] args){
        try{
            ...
            //System.out.println("Proxy Archive: "+countArticlesOfCategory("Category:ProxyArchive_(L)"));
