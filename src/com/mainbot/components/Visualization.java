...
public class Visualization {
	...
	public void recentChangeView(ArrayList<Revision> revisionList, String graphName) throws IOException {
        ...
        BufferedWriter writer= new BufferedWriter(new FileWriter(new File("/MainBot/visualizations/"+filename)));
	...
	public void changesPastNDaysView(ArrayList<Revision> revisionList, String graphName, int numOfDays) throws IOException {
		HashMap<String, Integer> histogramMap = new HashMap<>();
		int count = 1;
		String start = "", end = "";
        String result = "<h1> Changes in the wiki for the past "+String.valueOf(numOfDays)+" days</h1>\n<p>\n";
        for(Revision obj : revisionList){	
        	String date = obj.getTimestampDate();
        	if(count == 1)
        		start = date;
